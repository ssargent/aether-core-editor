...
const (
	...
	AttributeServiceName = "aethercore.v1.AttributeService"
)
...
const (
	...
	// CreateAttribute RPC.
	AttributeServiceCreateAttributeProcedure = "/aethercore.v1.AttributeService/CreateAttribute"
	// AttributeServiceGetAttributeProcedure is the fully-qualified name of the AttributeService's
	// GetAttribute RPC.
	AttributeServiceGetAttributeProcedure = "/aethercore.v1.AttributeService/GetAttribute"
	// AttributeServiceUpdateAttributeProcedure is the fully-qualified name of the AttributeService's
	// UpdateAttribute RPC.
	AttributeServiceUpdateAttributeProcedure = "/aethercore.v1.AttributeService/UpdateAttribute"
	// AttributeServiceDeleteAttributeProcedure is the fully-qualified name of the AttributeService's
	// DeleteAttribute RPC.
	AttributeServiceDeleteAttributeProcedure = "/aethercore.v1.AttributeService/DeleteAttribute"
	// AttributeServiceListAttributesProcedure is the fully-qualified name of the AttributeService's
	// ListAttributes RPC.
	AttributeServiceListAttributesProcedure = "/aethercore.v1.AttributeService/ListAttributes"
)

// AttributeServiceClient is a client for the aethercore.v1.AttributeService service.
...
// NewAttributeServiceClient constructs a client for the aethercore.v1.AttributeService service. By
...
func NewAttributeServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AttributeServiceClient {
	...
	attributeServiceMethods := v1.File_aethercore_v1_attribute_service_proto.Services().ByName("AttributeService").Methods()
...
// CreateAttribute calls aethercore.v1.AttributeService.CreateAttribute.
...
// GetAttribute calls aethercore.v1.AttributeService.GetAttribute.
...
// UpdateAttribute calls aethercore.v1.AttributeService.UpdateAttribute.
...
// DeleteAttribute calls aethercore.v1.AttributeService.DeleteAttribute.
...
// ListAttributes calls aethercore.v1.AttributeService.ListAttributes.
...
// AttributeServiceHandler is an implementation of the aethercore.v1.AttributeService service.
...
func NewAttributeServiceHandler(svc AttributeServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/aethercore.v1.AttributeService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAttributeServiceHandler) CreateAttribute(context.Context, *connect.Request[v1.CreateAttributeRequest]) (*connect.Response[v1.AttributeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.AttributeService.CreateAttribute is not implemented"))
}
...
func (UnimplementedAttributeServiceHandler) GetAttribute(context.Context, *connect.Request[v1.GetAttributeRequest]) (*connect.Response[v1.AttributeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.AttributeService.GetAttribute is not implemented"))
}
...
func (UnimplementedAttributeServiceHandler) UpdateAttribute(context.Context, *connect.Request[v1.UpdateAttributeRequest]) (*connect.Response[v1.AttributeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.AttributeService.UpdateAttribute is not implemented"))
}
...
func (UnimplementedAttributeServiceHandler) DeleteAttribute(context.Context, *connect.Request[v1.DeleteAttributeRequest]) (*connect.Response[v1.DeleteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.AttributeService.DeleteAttribute is not implemented"))
}
...
func (UnimplementedAttributeServiceHandler) ListAttributes(context.Context, *connect.Request[v1.ListAttributesRequest]) (*connect.Response[v1.ListAttributesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.AttributeService.ListAttributes is not implemented"))
}
