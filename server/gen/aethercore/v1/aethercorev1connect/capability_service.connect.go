...
const (
	...
	CapabilityServiceName = "aethercore.v1.CapabilityService"
)
...
const (
	...
	CapabilityServiceCreateCapabilityProcedure = "/aethercore.v1.CapabilityService/CreateCapability"
	// CapabilityServiceGetCapabilityProcedure is the fully-qualified name of the CapabilityService's
	// GetCapability RPC.
	CapabilityServiceGetCapabilityProcedure = "/aethercore.v1.CapabilityService/GetCapability"
	// CapabilityServiceUpdateCapabilityProcedure is the fully-qualified name of the CapabilityService's
	// UpdateCapability RPC.
	CapabilityServiceUpdateCapabilityProcedure = "/aethercore.v1.CapabilityService/UpdateCapability"
	// CapabilityServiceDeleteCapabilityProcedure is the fully-qualified name of the CapabilityService's
	// DeleteCapability RPC.
	CapabilityServiceDeleteCapabilityProcedure = "/aethercore.v1.CapabilityService/DeleteCapability"
	// CapabilityServiceListCapabilitiesProcedure is the fully-qualified name of the CapabilityService's
	// ListCapabilities RPC.
	CapabilityServiceListCapabilitiesProcedure = "/aethercore.v1.CapabilityService/ListCapabilities"
)

// CapabilityServiceClient is a client for the aethercore.v1.CapabilityService service.
...
// NewCapabilityServiceClient constructs a client for the aethercore.v1.CapabilityService service.
...
func NewCapabilityServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) CapabilityServiceClient {
	...
	capabilityServiceMethods := v1.File_aethercore_v1_capability_service_proto.Services().ByName("CapabilityService").Methods()
...
// CreateCapability calls aethercore.v1.CapabilityService.CreateCapability.
...
// GetCapability calls aethercore.v1.CapabilityService.GetCapability.
...
// UpdateCapability calls aethercore.v1.CapabilityService.UpdateCapability.
...
// DeleteCapability calls aethercore.v1.CapabilityService.DeleteCapability.
...
// ListCapabilities calls aethercore.v1.CapabilityService.ListCapabilities.
...
// CapabilityServiceHandler is an implementation of the aethercore.v1.CapabilityService service.
...
func NewCapabilityServiceHandler(svc CapabilityServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/aethercore.v1.CapabilityService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedCapabilityServiceHandler) CreateCapability(context.Context, *connect.Request[v1.CreateCapabilityRequest]) (*connect.Response[v1.CapabilityResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.CapabilityService.CreateCapability is not implemented"))
}
...
func (UnimplementedCapabilityServiceHandler) GetCapability(context.Context, *connect.Request[v1.GetCapabilityRequest]) (*connect.Response[v1.CapabilityResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.CapabilityService.GetCapability is not implemented"))
}
...
func (UnimplementedCapabilityServiceHandler) UpdateCapability(context.Context, *connect.Request[v1.UpdateCapabilityRequest]) (*connect.Response[v1.CapabilityResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.CapabilityService.UpdateCapability is not implemented"))
}
...
func (UnimplementedCapabilityServiceHandler) DeleteCapability(context.Context, *connect.Request[v1.DeleteCapabilityRequest]) (*connect.Response[v1.DeleteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.CapabilityService.DeleteCapability is not implemented"))
}
...
func (UnimplementedCapabilityServiceHandler) ListCapabilities(context.Context, *connect.Request[v1.ListCapabilitiesRequest]) (*connect.Response[v1.ListCapabilitiesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.CapabilityService.ListCapabilities is not implemented"))
}
