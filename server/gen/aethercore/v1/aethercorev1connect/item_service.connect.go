...
const (
	...
	ItemCategoryServiceName = "aethercore.v1.ItemCategoryService"
	// ItemServiceName is the fully-qualified name of the ItemService service.
	ItemServiceName = "aethercore.v1.ItemService"
)
...
const (
	...
	ItemCategoryServiceCreateItemCategoryProcedure = "/aethercore.v1.ItemCategoryService/CreateItemCategory"
	// ItemCategoryServiceGetItemCategoryProcedure is the fully-qualified name of the
	// ItemCategoryService's GetItemCategory RPC.
	ItemCategoryServiceGetItemCategoryProcedure = "/aethercore.v1.ItemCategoryService/GetItemCategory"
	...
	ItemCategoryServiceUpdateItemCategoryProcedure = "/aethercore.v1.ItemCategoryService/UpdateItemCategory"
	...
	ItemCategoryServiceDeleteItemCategoryProcedure = "/aethercore.v1.ItemCategoryService/DeleteItemCategory"
	...
	ItemCategoryServiceListItemCategoriesProcedure = "/aethercore.v1.ItemCategoryService/ListItemCategories"
	// ItemServiceCreateItemProcedure is the fully-qualified name of the ItemService's CreateItem RPC.
	ItemServiceCreateItemProcedure = "/aethercore.v1.ItemService/CreateItem"
	// ItemServiceGetItemProcedure is the fully-qualified name of the ItemService's GetItem RPC.
	ItemServiceGetItemProcedure = "/aethercore.v1.ItemService/GetItem"
	// ItemServiceUpdateItemProcedure is the fully-qualified name of the ItemService's UpdateItem RPC.
	ItemServiceUpdateItemProcedure = "/aethercore.v1.ItemService/UpdateItem"
	// ItemServiceDeleteItemProcedure is the fully-qualified name of the ItemService's DeleteItem RPC.
	ItemServiceDeleteItemProcedure = "/aethercore.v1.ItemService/DeleteItem"
	// ItemServiceListItemsProcedure is the fully-qualified name of the ItemService's ListItems RPC.
	ItemServiceListItemsProcedure = "/aethercore.v1.ItemService/ListItems"
)

// ItemCategoryServiceClient is a client for the aethercore.v1.ItemCategoryService service.
...
// NewItemCategoryServiceClient constructs a client for the aethercore.v1.ItemCategoryService
...
func NewItemCategoryServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ItemCategoryServiceClient {
	...
	itemCategoryServiceMethods := v1.File_aethercore_v1_item_service_proto.Services().ByName("ItemCategoryService").Methods()
...
// CreateItemCategory calls aethercore.v1.ItemCategoryService.CreateItemCategory.
...
// GetItemCategory calls aethercore.v1.ItemCategoryService.GetItemCategory.
...
// UpdateItemCategory calls aethercore.v1.ItemCategoryService.UpdateItemCategory.
...
// DeleteItemCategory calls aethercore.v1.ItemCategoryService.DeleteItemCategory.
...
// ListItemCategories calls aethercore.v1.ItemCategoryService.ListItemCategories.
...
// ItemCategoryServiceHandler is an implementation of the aethercore.v1.ItemCategoryService service.
...
func NewItemCategoryServiceHandler(svc ItemCategoryServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/aethercore.v1.ItemCategoryService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedItemCategoryServiceHandler) CreateItemCategory(context.Context, *connect.Request[v1.CreateItemCategoryRequest]) (*connect.Response[v1.ItemCategoryResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.ItemCategoryService.CreateItemCategory is not implemented"))
}
...
func (UnimplementedItemCategoryServiceHandler) GetItemCategory(context.Context, *connect.Request[v1.GetItemCategoryRequest]) (*connect.Response[v1.ItemCategoryResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.ItemCategoryService.GetItemCategory is not implemented"))
}
...
func (UnimplementedItemCategoryServiceHandler) UpdateItemCategory(context.Context, *connect.Request[v1.UpdateItemCategoryRequest]) (*connect.Response[v1.ItemCategoryResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.ItemCategoryService.UpdateItemCategory is not implemented"))
}
...
func (UnimplementedItemCategoryServiceHandler) DeleteItemCategory(context.Context, *connect.Request[v1.DeleteItemCategoryRequest]) (*connect.Response[v1.DeleteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.ItemCategoryService.DeleteItemCategory is not implemented"))
}
...
func (UnimplementedItemCategoryServiceHandler) ListItemCategories(context.Context, *connect.Request[v1.ListItemCategoriesRequest]) (*connect.Response[v1.ListItemCategoriesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.ItemCategoryService.ListItemCategories is not implemented"))
}

// ItemServiceClient is a client for the aethercore.v1.ItemService service.
...
// NewItemServiceClient constructs a client for the aethercore.v1.ItemService service. By default,
...
func NewItemServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ItemServiceClient {
	baseURL = strings.TrimRight(baseURL, "/")
	itemServiceMethods := v1.File_aethercore_v1_item_service_proto.Services().ByName("ItemService").Methods()
...
// CreateItem calls aethercore.v1.ItemService.CreateItem.
...
// GetItem calls aethercore.v1.ItemService.GetItem.
...
// UpdateItem calls aethercore.v1.ItemService.UpdateItem.
...
// DeleteItem calls aethercore.v1.ItemService.DeleteItem.
...
// ListItems calls aethercore.v1.ItemService.ListItems.
...
// ItemServiceHandler is an implementation of the aethercore.v1.ItemService service.
...
func NewItemServiceHandler(svc ItemServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/aethercore.v1.ItemService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedItemServiceHandler) CreateItem(context.Context, *connect.Request[v1.CreateItemRequest]) (*connect.Response[v1.ItemResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.ItemService.CreateItem is not implemented"))
}
...
func (UnimplementedItemServiceHandler) GetItem(context.Context, *connect.Request[v1.GetItemRequest]) (*connect.Response[v1.ItemResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.ItemService.GetItem is not implemented"))
}
...
func (UnimplementedItemServiceHandler) UpdateItem(context.Context, *connect.Request[v1.UpdateItemRequest]) (*connect.Response[v1.ItemResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.ItemService.UpdateItem is not implemented"))
}
...
func (UnimplementedItemServiceHandler) DeleteItem(context.Context, *connect.Request[v1.DeleteItemRequest]) (*connect.Response[v1.DeleteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.ItemService.DeleteItem is not implemented"))
}
...
func (UnimplementedItemServiceHandler) ListItems(context.Context, *connect.Request[v1.ListItemsRequest]) (*connect.Response[v1.ListItemsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.ItemService.ListItems is not implemented"))
}
