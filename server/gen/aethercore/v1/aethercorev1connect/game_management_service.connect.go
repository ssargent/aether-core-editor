...
const (
	...
	GameManagementServiceName = "aethercore.v1.GameManagementService"
)
...
const (
	...
	GameManagementServiceExportWorldProcedure = "/aethercore.v1.GameManagementService/ExportWorld"
	// GameManagementServiceImportWorldProcedure is the fully-qualified name of the
	// GameManagementService's ImportWorld RPC.
	GameManagementServiceImportWorldProcedure = "/aethercore.v1.GameManagementService/ImportWorld"
	...
	GameManagementServiceGetWorldStatisticsProcedure = "/aethercore.v1.GameManagementService/GetWorldStatistics"
	...
	GameManagementServiceGetGameSystemHealthProcedure = "/aethercore.v1.GameManagementService/GetGameSystemHealth"
	// GameManagementServiceFilterWorldsProcedure is the fully-qualified name of the
	// GameManagementService's FilterWorlds RPC.
	GameManagementServiceFilterWorldsProcedure = "/aethercore.v1.GameManagementService/FilterWorlds"
	...
	GameManagementServiceFilterAttributesProcedure = "/aethercore.v1.GameManagementService/FilterAttributes"
	...
	GameManagementServiceFilterCapabilitiesProcedure = "/aethercore.v1.GameManagementService/FilterCapabilities"
	...
	GameManagementServiceFilterCharacterClassesProcedure = "/aethercore.v1.GameManagementService/FilterCharacterClasses"
	...
	GameManagementServiceFilterCharacterClassFeaturesProcedure = "/aethercore.v1.GameManagementService/FilterCharacterClassFeatures"
	...
	GameManagementServiceFilterCurrenciesProcedure = "/aethercore.v1.GameManagementService/FilterCurrencies"
	// GameManagementServiceFilterEnemiesProcedure is the fully-qualified name of the
	// GameManagementService's FilterEnemies RPC.
	GameManagementServiceFilterEnemiesProcedure = "/aethercore.v1.GameManagementService/FilterEnemies"
	...
	GameManagementServiceFilterItemCategoriesProcedure = "/aethercore.v1.GameManagementService/FilterItemCategories"
	// GameManagementServiceFilterItemsProcedure is the fully-qualified name of the
	// GameManagementService's FilterItems RPC.
	GameManagementServiceFilterItemsProcedure = "/aethercore.v1.GameManagementService/FilterItems"
	...
	GameManagementServiceFilterNpcTemplatesProcedure = "/aethercore.v1.GameManagementService/FilterNpcTemplates"
	...
	GameManagementServiceFilterNpcSpawnRulesProcedure = "/aethercore.v1.GameManagementService/FilterNpcSpawnRules"
	// GameManagementServiceFilterRacesProcedure is the fully-qualified name of the
	// GameManagementService's FilterRaces RPC.
	GameManagementServiceFilterRacesProcedure = "/aethercore.v1.GameManagementService/FilterRaces"
	...
	GameManagementServiceFilterWorldNodesProcedure = "/aethercore.v1.GameManagementService/FilterWorldNodes"
	...
	GameManagementServiceFilterWorldNodeFeaturesProcedure = "/aethercore.v1.GameManagementService/FilterWorldNodeFeatures"
)

// GameManagementServiceClient is a client for the aethercore.v1.GameManagementService service.
...
// NewGameManagementServiceClient constructs a client for the aethercore.v1.GameManagementService
...
func NewGameManagementServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) GameManagementServiceClient {
	...
	gameManagementServiceMethods := v1.File_aethercore_v1_game_management_service_proto.Services().ByName("GameManagementService").Methods()
...
// ExportWorld calls aethercore.v1.GameManagementService.ExportWorld.
...
// ImportWorld calls aethercore.v1.GameManagementService.ImportWorld.
...
// GetWorldStatistics calls aethercore.v1.GameManagementService.GetWorldStatistics.
...
// GetGameSystemHealth calls aethercore.v1.GameManagementService.GetGameSystemHealth.
...
// FilterWorlds calls aethercore.v1.GameManagementService.FilterWorlds.
...
// FilterAttributes calls aethercore.v1.GameManagementService.FilterAttributes.
...
// FilterCapabilities calls aethercore.v1.GameManagementService.FilterCapabilities.
...
// FilterCharacterClasses calls aethercore.v1.GameManagementService.FilterCharacterClasses.
...
// FilterCharacterClassFeatures calls
// aethercore.v1.GameManagementService.FilterCharacterClassFeatures.
...
// FilterCurrencies calls aethercore.v1.GameManagementService.FilterCurrencies.
...
// FilterEnemies calls aethercore.v1.GameManagementService.FilterEnemies.
...
// FilterItemCategories calls aethercore.v1.GameManagementService.FilterItemCategories.
...
// FilterItems calls aethercore.v1.GameManagementService.FilterItems.
...
// FilterNpcTemplates calls aethercore.v1.GameManagementService.FilterNpcTemplates.
...
// FilterNpcSpawnRules calls aethercore.v1.GameManagementService.FilterNpcSpawnRules.
...
// FilterRaces calls aethercore.v1.GameManagementService.FilterRaces.
...
// FilterWorldNodes calls aethercore.v1.GameManagementService.FilterWorldNodes.
...
// FilterWorldNodeFeatures calls aethercore.v1.GameManagementService.FilterWorldNodeFeatures.
...
// GameManagementServiceHandler is an implementation of the aethercore.v1.GameManagementService
// service.
...
func NewGameManagementServiceHandler(svc GameManagementServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/aethercore.v1.GameManagementService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedGameManagementServiceHandler) ExportWorld(context.Context, *connect.Request[v1.Id], *connect.ServerStream[structpb.Struct]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.GameManagementService.ExportWorld is not implemented"))
}
...
func (UnimplementedGameManagementServiceHandler) ImportWorld(context.Context, *connect.ClientStream[structpb.Struct]) (*connect.Response[v1.WorldResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.GameManagementService.ImportWorld is not implemented"))
}
...
func (UnimplementedGameManagementServiceHandler) GetWorldStatistics(context.Context, *connect.Request[v1.Id]) (*connect.Response[structpb.Struct], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.GameManagementService.GetWorldStatistics is not implemented"))
}
...
func (UnimplementedGameManagementServiceHandler) GetGameSystemHealth(context.Context, *connect.Request[emptypb.Empty]) (*connect.Response[structpb.Struct], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.GameManagementService.GetGameSystemHealth is not implemented"))
}
...
func (UnimplementedGameManagementServiceHandler) FilterWorlds(context.Context, *connect.Request[v1.WorldFilter]) (*connect.Response[v1.ListWorldsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.GameManagementService.FilterWorlds is not implemented"))
}
...
func (UnimplementedGameManagementServiceHandler) FilterAttributes(context.Context, *connect.Request[v1.AttributeFilter]) (*connect.Response[v1.ListAttributesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.GameManagementService.FilterAttributes is not implemented"))
}
...
func (UnimplementedGameManagementServiceHandler) FilterCapabilities(context.Context, *connect.Request[v1.CapabilityFilter]) (*connect.Response[v1.ListCapabilitiesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.GameManagementService.FilterCapabilities is not implemented"))
}
...
func (UnimplementedGameManagementServiceHandler) FilterCharacterClasses(context.Context, *connect.Request[v1.CharacterClassFilter]) (*connect.Response[v1.ListCharacterClassesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.GameManagementService.FilterCharacterClasses is not implemented"))
}
...
func (UnimplementedGameManagementServiceHandler) FilterCharacterClassFeatures(context.Context, *connect.Request[v1.CharacterClassFeatureFilter]) (*connect.Response[v1.ListCharacterClassFeaturesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.GameManagementService.FilterCharacterClassFeatures is not implemented"))
}
...
func (UnimplementedGameManagementServiceHandler) FilterCurrencies(context.Context, *connect.Request[v1.CurrencyFilter]) (*connect.Response[v1.ListCurrenciesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.GameManagementService.FilterCurrencies is not implemented"))
}
...
func (UnimplementedGameManagementServiceHandler) FilterEnemies(context.Context, *connect.Request[v1.EnemyFilter]) (*connect.Response[v1.ListEnemiesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.GameManagementService.FilterEnemies is not implemented"))
}
...
func (UnimplementedGameManagementServiceHandler) FilterItemCategories(context.Context, *connect.Request[v1.ItemCategoryFilter]) (*connect.Response[v1.ListItemCategoriesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.GameManagementService.FilterItemCategories is not implemented"))
}
...
func (UnimplementedGameManagementServiceHandler) FilterItems(context.Context, *connect.Request[v1.ItemFilter]) (*connect.Response[v1.ListItemsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.GameManagementService.FilterItems is not implemented"))
}
...
func (UnimplementedGameManagementServiceHandler) FilterNpcTemplates(context.Context, *connect.Request[v1.NpcTemplateFilter]) (*connect.Response[v1.ListNpcTemplatesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.GameManagementService.FilterNpcTemplates is not implemented"))
}
...
func (UnimplementedGameManagementServiceHandler) FilterNpcSpawnRules(context.Context, *connect.Request[v1.NpcSpawnRuleFilter]) (*connect.Response[v1.ListNpcSpawnRulesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.GameManagementService.FilterNpcSpawnRules is not implemented"))
}
...
func (UnimplementedGameManagementServiceHandler) FilterRaces(context.Context, *connect.Request[v1.RaceFilter]) (*connect.Response[v1.ListRacesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.GameManagementService.FilterRaces is not implemented"))
}
...
func (UnimplementedGameManagementServiceHandler) FilterWorldNodes(context.Context, *connect.Request[v1.WorldNodeFilter]) (*connect.Response[v1.ListWorldNodesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.GameManagementService.FilterWorldNodes is not implemented"))
}
...
func (UnimplementedGameManagementServiceHandler) FilterWorldNodeFeatures(context.Context, *connect.Request[v1.WorldNodeFeatureFilter]) (*connect.Response[v1.ListWorldNodeFeaturesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.GameManagementService.FilterWorldNodeFeatures is not implemented"))
}
