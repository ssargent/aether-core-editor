...
const (
	...
	WorldNodeServiceName = "aethercore.v1.WorldNodeService"
)
...
const (
	...
	// CreateWorldNode RPC.
	WorldNodeServiceCreateWorldNodeProcedure = "/aethercore.v1.WorldNodeService/CreateWorldNode"
	// WorldNodeServiceGetWorldNodeProcedure is the fully-qualified name of the WorldNodeService's
	// GetWorldNode RPC.
	WorldNodeServiceGetWorldNodeProcedure = "/aethercore.v1.WorldNodeService/GetWorldNode"
	// WorldNodeServiceUpdateWorldNodeProcedure is the fully-qualified name of the WorldNodeService's
	// UpdateWorldNode RPC.
	WorldNodeServiceUpdateWorldNodeProcedure = "/aethercore.v1.WorldNodeService/UpdateWorldNode"
	// WorldNodeServiceDeleteWorldNodeProcedure is the fully-qualified name of the WorldNodeService's
	// DeleteWorldNode RPC.
	WorldNodeServiceDeleteWorldNodeProcedure = "/aethercore.v1.WorldNodeService/DeleteWorldNode"
	// WorldNodeServiceListWorldNodesProcedure is the fully-qualified name of the WorldNodeService's
	// ListWorldNodes RPC.
	WorldNodeServiceListWorldNodesProcedure = "/aethercore.v1.WorldNodeService/ListWorldNodes"
	...
	WorldNodeServiceCreateWorldNodeFeatureProcedure = "/aethercore.v1.WorldNodeService/CreateWorldNodeFeature"
	...
	WorldNodeServiceGetWorldNodeFeatureProcedure = "/aethercore.v1.WorldNodeService/GetWorldNodeFeature"
	...
	WorldNodeServiceUpdateWorldNodeFeatureProcedure = "/aethercore.v1.WorldNodeService/UpdateWorldNodeFeature"
	...
	WorldNodeServiceDeleteWorldNodeFeatureProcedure = "/aethercore.v1.WorldNodeService/DeleteWorldNodeFeature"
	...
	WorldNodeServiceListWorldNodeFeaturesProcedure = "/aethercore.v1.WorldNodeService/ListWorldNodeFeatures"
)

// WorldNodeServiceClient is a client for the aethercore.v1.WorldNodeService service.
...
// NewWorldNodeServiceClient constructs a client for the aethercore.v1.WorldNodeService service. By
...
func NewWorldNodeServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) WorldNodeServiceClient {
	...
	worldNodeServiceMethods := v1.File_aethercore_v1_world_node_service_proto.Services().ByName("WorldNodeService").Methods()
...
// CreateWorldNode calls aethercore.v1.WorldNodeService.CreateWorldNode.
...
// GetWorldNode calls aethercore.v1.WorldNodeService.GetWorldNode.
...
// UpdateWorldNode calls aethercore.v1.WorldNodeService.UpdateWorldNode.
...
// DeleteWorldNode calls aethercore.v1.WorldNodeService.DeleteWorldNode.
...
// ListWorldNodes calls aethercore.v1.WorldNodeService.ListWorldNodes.
...
// CreateWorldNodeFeature calls aethercore.v1.WorldNodeService.CreateWorldNodeFeature.
...
// GetWorldNodeFeature calls aethercore.v1.WorldNodeService.GetWorldNodeFeature.
...
// UpdateWorldNodeFeature calls aethercore.v1.WorldNodeService.UpdateWorldNodeFeature.
...
// DeleteWorldNodeFeature calls aethercore.v1.WorldNodeService.DeleteWorldNodeFeature.
...
// ListWorldNodeFeatures calls aethercore.v1.WorldNodeService.ListWorldNodeFeatures.
...
// WorldNodeServiceHandler is an implementation of the aethercore.v1.WorldNodeService service.
...
func NewWorldNodeServiceHandler(svc WorldNodeServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/aethercore.v1.WorldNodeService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedWorldNodeServiceHandler) CreateWorldNode(context.Context, *connect.Request[v1.CreateWorldNodeRequest]) (*connect.Response[v1.WorldNodeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.WorldNodeService.CreateWorldNode is not implemented"))
}
...
func (UnimplementedWorldNodeServiceHandler) GetWorldNode(context.Context, *connect.Request[v1.GetWorldNodeRequest]) (*connect.Response[v1.WorldNodeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.WorldNodeService.GetWorldNode is not implemented"))
}
...
func (UnimplementedWorldNodeServiceHandler) UpdateWorldNode(context.Context, *connect.Request[v1.UpdateWorldNodeRequest]) (*connect.Response[v1.WorldNodeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.WorldNodeService.UpdateWorldNode is not implemented"))
}
...
func (UnimplementedWorldNodeServiceHandler) DeleteWorldNode(context.Context, *connect.Request[v1.DeleteWorldNodeRequest]) (*connect.Response[v1.DeleteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.WorldNodeService.DeleteWorldNode is not implemented"))
}
...
func (UnimplementedWorldNodeServiceHandler) ListWorldNodes(context.Context, *connect.Request[v1.ListWorldNodesRequest]) (*connect.Response[v1.ListWorldNodesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.WorldNodeService.ListWorldNodes is not implemented"))
}
...
func (UnimplementedWorldNodeServiceHandler) CreateWorldNodeFeature(context.Context, *connect.Request[v1.CreateWorldNodeFeatureRequest]) (*connect.Response[v1.WorldNodeFeatureResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.WorldNodeService.CreateWorldNodeFeature is not implemented"))
}
...
func (UnimplementedWorldNodeServiceHandler) GetWorldNodeFeature(context.Context, *connect.Request[v1.GetWorldNodeFeatureRequest]) (*connect.Response[v1.WorldNodeFeatureResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.WorldNodeService.GetWorldNodeFeature is not implemented"))
}
...
func (UnimplementedWorldNodeServiceHandler) UpdateWorldNodeFeature(context.Context, *connect.Request[v1.UpdateWorldNodeFeatureRequest]) (*connect.Response[v1.WorldNodeFeatureResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.WorldNodeService.UpdateWorldNodeFeature is not implemented"))
}
...
func (UnimplementedWorldNodeServiceHandler) DeleteWorldNodeFeature(context.Context, *connect.Request[v1.DeleteWorldNodeFeatureRequest]) (*connect.Response[v1.DeleteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.WorldNodeService.DeleteWorldNodeFeature is not implemented"))
}
...
func (UnimplementedWorldNodeServiceHandler) ListWorldNodeFeatures(context.Context, *connect.Request[v1.ListWorldNodeFeaturesRequest]) (*connect.Response[v1.ListWorldNodeFeaturesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.WorldNodeService.ListWorldNodeFeatures is not implemented"))
}
