...
const (
	...
	WorldServiceName = "aethercore.v1.WorldService"
)
...
const (
	...
	// RPC.
	WorldServiceCreateWorldProcedure = "/aethercore.v1.WorldService/CreateWorld"
	// WorldServiceGetWorldProcedure is the fully-qualified name of the WorldService's GetWorld RPC.
	WorldServiceGetWorldProcedure = "/aethercore.v1.WorldService/GetWorld"
	// WorldServiceUpdateWorldProcedure is the fully-qualified name of the WorldService's UpdateWorld
	// RPC.
	WorldServiceUpdateWorldProcedure = "/aethercore.v1.WorldService/UpdateWorld"
	// WorldServiceDeleteWorldProcedure is the fully-qualified name of the WorldService's DeleteWorld
	// RPC.
	WorldServiceDeleteWorldProcedure = "/aethercore.v1.WorldService/DeleteWorld"
	// WorldServiceListWorldsProcedure is the fully-qualified name of the WorldService's ListWorlds RPC.
	WorldServiceListWorldsProcedure = "/aethercore.v1.WorldService/ListWorlds"
)

// WorldServiceClient is a client for the aethercore.v1.WorldService service.
...
// NewWorldServiceClient constructs a client for the aethercore.v1.WorldService service. By default,
...
func NewWorldServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) WorldServiceClient {
	...
	worldServiceMethods := v1.File_aethercore_v1_world_service_proto.Services().ByName("WorldService").Methods()
...
// CreateWorld calls aethercore.v1.WorldService.CreateWorld.
...
// GetWorld calls aethercore.v1.WorldService.GetWorld.
...
// UpdateWorld calls aethercore.v1.WorldService.UpdateWorld.
...
// DeleteWorld calls aethercore.v1.WorldService.DeleteWorld.
...
// ListWorlds calls aethercore.v1.WorldService.ListWorlds.
...
// WorldServiceHandler is an implementation of the aethercore.v1.WorldService service.
...
func NewWorldServiceHandler(svc WorldServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/aethercore.v1.WorldService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedWorldServiceHandler) CreateWorld(context.Context, *connect.Request[v1.CreateWorldRequest]) (*connect.Response[v1.WorldResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.WorldService.CreateWorld is not implemented"))
}
...
func (UnimplementedWorldServiceHandler) GetWorld(context.Context, *connect.Request[v1.GetWorldRequest]) (*connect.Response[v1.WorldResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.WorldService.GetWorld is not implemented"))
}
...
func (UnimplementedWorldServiceHandler) UpdateWorld(context.Context, *connect.Request[v1.UpdateWorldRequest]) (*connect.Response[v1.WorldResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.WorldService.UpdateWorld is not implemented"))
}
...
func (UnimplementedWorldServiceHandler) DeleteWorld(context.Context, *connect.Request[v1.DeleteWorldRequest]) (*connect.Response[v1.DeleteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.WorldService.DeleteWorld is not implemented"))
}
...
func (UnimplementedWorldServiceHandler) ListWorlds(context.Context, *connect.Request[v1.ListWorldsRequest]) (*connect.Response[v1.ListWorldsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aethercore.v1.WorldService.ListWorlds is not implemented"))
}
