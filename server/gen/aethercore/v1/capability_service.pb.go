...
// 	protoc        (unknown)
// source: aethercore/v1/capability_service.proto
...
func (x *Capability) Reset() {
	*x = Capability{}
	mi := &file_aethercore_v1_capability_service_proto_msgTypes[0]
...
func (*Capability) Descriptor() ([]byte, []int) {
	return file_aethercore_v1_capability_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CreateCapabilityRequest) Reset() {
	*x = CreateCapabilityRequest{}
	mi := &file_aethercore_v1_capability_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateCapabilityRequest) Descriptor() ([]byte, []int) {
	return file_aethercore_v1_capability_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *UpdateCapabilityRequest) Reset() {
	*x = UpdateCapabilityRequest{}
	mi := &file_aethercore_v1_capability_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateCapabilityRequest) Descriptor() ([]byte, []int) {
	return file_aethercore_v1_capability_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *GetCapabilityRequest) Reset() {
	*x = GetCapabilityRequest{}
	mi := &file_aethercore_v1_capability_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetCapabilityRequest) Descriptor() ([]byte, []int) {
	return file_aethercore_v1_capability_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *DeleteCapabilityRequest) Reset() {
	*x = DeleteCapabilityRequest{}
	mi := &file_aethercore_v1_capability_service_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteCapabilityRequest) Descriptor() ([]byte, []int) {
	return file_aethercore_v1_capability_service_proto_rawDescGZIP(), []int{4}
}
...
func (x *ListCapabilitiesRequest) Reset() {
	*x = ListCapabilitiesRequest{}
	mi := &file_aethercore_v1_capability_service_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListCapabilitiesRequest) Descriptor() ([]byte, []int) {
	return file_aethercore_v1_capability_service_proto_rawDescGZIP(), []int{5}
}
...
func (x *CapabilityResponse) Reset() {
	*x = CapabilityResponse{}
	mi := &file_aethercore_v1_capability_service_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CapabilityResponse) Descriptor() ([]byte, []int) {
	return file_aethercore_v1_capability_service_proto_rawDescGZIP(), []int{6}
}
...
func (x *ListCapabilitiesResponse) Reset() {
	*x = ListCapabilitiesResponse{}
	mi := &file_aethercore_v1_capability_service_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListCapabilitiesResponse) Descriptor() ([]byte, []int) {
	return file_aethercore_v1_capability_service_proto_rawDescGZIP(), []int{7}
}
...
func (x *CapabilityFilter) Reset() {
	*x = CapabilityFilter{}
	mi := &file_aethercore_v1_capability_service_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CapabilityFilter) Descriptor() ([]byte, []int) {
	return file_aethercore_v1_capability_service_proto_rawDescGZIP(), []int{8}
}
...
var File_aethercore_v1_capability_service_proto protoreflect.FileDescriptor

const file_aethercore_v1_capability_service_proto_rawDesc = "" +
	"\n" +
	"&aethercore/v1/capability_service.proto\x12\raethercore.v1\x1a\x1aaethercore/v1/common.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xd5\x04\n" +
	"\n" +
	"Capability\x12\x0e\n" +
	...
	"\x13gameplay_definition\x18\f \x01(\v2\x17.google.protobuf.StructH\x02R\x12gameplayDefinition\x88\x01\x01\x123\n" +
	"\bmetadata\x18\r \x01(\v2\x17.aethercore.v1.MetadataR\bmetadataB\f\n" +
	"\n" +
	"_parent_idB\n" +
	"\n" +
	"\b_actionsB\x16\n" +
	...
	"\x12CapabilityResponse\x129\n" +
	"\n" +
	"capability\x18\x01 \x01(\v2\x19.aethercore.v1.CapabilityR\n" +
	"capability\"\x9c\x01\n" +
	"\x18ListCapabilitiesResponse\x12=\n" +
	"\fcapabilities\x18\x01 \x03(\v2\x19.aethercore.v1.CapabilityR\fcapabilities\x12A\n" +
	"\n" +
	...
	"\x10CreateCapability\x12&.aethercore.v1.CreateCapabilityRequest\x1a!.aethercore.v1.CapabilityResponse\x12W\n" +
	"\rGetCapability\x12#.aethercore.v1.GetCapabilityRequest\x1a!.aethercore.v1.CapabilityResponse\x12]\n" +
	"\x10UpdateCapability\x12&.aethercore.v1.UpdateCapabilityRequest\x1a!.aethercore.v1.CapabilityResponse\x12Y\n" +
	"\x10DeleteCapability\x12&.aethercore.v1.DeleteCapabilityRequest\x1a\x1d.aethercore.v1.DeleteResponse\x12c\n" +
	"\x10ListCapabilities\x12&.aethercore.v1.ListCapabilitiesRequest\x1a'.aethercore.v1.ListCapabilitiesResponseB\xc7\x01\n" +
	"\x11com.aethercore.v1B\x16CapabilityServiceProtoP\x01ZEgithub.com/ssargent/aether-core-editor/gen/aethercore/v1;aethercorev1\xa2\x02\x03AXX\xaa\x02\rAethercore.V1\xca\x02\rAethercore\\V1\xe2\x02\x19Aethercore\\V1\\GPBMetadata\xea\x02\x0eAethercore::V1b\x06proto3"

var (
	file_aethercore_v1_capability_service_proto_rawDescOnce sync.Once
	file_aethercore_v1_capability_service_proto_rawDescData []byte
)

func file_aethercore_v1_capability_service_proto_rawDescGZIP() []byte {
	file_aethercore_v1_capability_service_proto_rawDescOnce.Do(func() {
		file_aethercore_v1_capability_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_aethercore_v1_capability_service_proto_rawDesc), len(file_aethercore_v1_capability_service_proto_rawDesc)))
	})
	return file_aethercore_v1_capability_service_proto_rawDescData
}

var file_aethercore_v1_capability_service_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_aethercore_v1_capability_service_proto_goTypes = []any{
	(*Capability)(nil),               // 0: aethercore.v1.Capability
	(*CreateCapabilityRequest)(nil),  // 1: aethercore.v1.CreateCapabilityRequest
	(*UpdateCapabilityRequest)(nil),  // 2: aethercore.v1.UpdateCapabilityRequest
	(*GetCapabilityRequest)(nil),     // 3: aethercore.v1.GetCapabilityRequest
	(*DeleteCapabilityRequest)(nil),  // 4: aethercore.v1.DeleteCapabilityRequest
	(*ListCapabilitiesRequest)(nil),  // 5: aethercore.v1.ListCapabilitiesRequest
	(*CapabilityResponse)(nil),       // 6: aethercore.v1.CapabilityResponse
	(*ListCapabilitiesResponse)(nil), // 7: aethercore.v1.ListCapabilitiesResponse
	(*CapabilityFilter)(nil),         // 8: aethercore.v1.CapabilityFilter
...
var file_aethercore_v1_capability_service_proto_depIdxs = []int32{
	9,  // 0: aethercore.v1.Capability.requirements:type_name -> google.protobuf.Struct
	9,  // 1: aethercore.v1.Capability.actions:type_name -> google.protobuf.Struct
	9,  // 2: aethercore.v1.Capability.access_requirements:type_name -> google.protobuf.Struct
	9,  // 3: aethercore.v1.Capability.gameplay_definition:type_name -> google.protobuf.Struct
	10, // 4: aethercore.v1.Capability.metadata:type_name -> aethercore.v1.Metadata
	9,  // 5: aethercore.v1.CreateCapabilityRequest.requirements:type_name -> google.protobuf.Struct
	9,  // 6: aethercore.v1.CreateCapabilityRequest.actions:type_name -> google.protobuf.Struct
	9,  // 7: aethercore.v1.CreateCapabilityRequest.access_requirements:type_name -> google.protobuf.Struct
	9,  // 8: aethercore.v1.CreateCapabilityRequest.gameplay_definition:type_name -> google.protobuf.Struct
	9,  // 9: aethercore.v1.UpdateCapabilityRequest.requirements:type_name -> google.protobuf.Struct
	9,  // 10: aethercore.v1.UpdateCapabilityRequest.actions:type_name -> google.protobuf.Struct
	9,  // 11: aethercore.v1.UpdateCapabilityRequest.access_requirements:type_name -> google.protobuf.Struct
	9,  // 12: aethercore.v1.UpdateCapabilityRequest.gameplay_definition:type_name -> google.protobuf.Struct
	0,  // 13: aethercore.v1.CapabilityResponse.capability:type_name -> aethercore.v1.Capability
	0,  // 14: aethercore.v1.ListCapabilitiesResponse.capabilities:type_name -> aethercore.v1.Capability
	11, // 15: aethercore.v1.ListCapabilitiesResponse.pagination:type_name -> aethercore.v1.PaginationResponse
	1,  // 16: aethercore.v1.CapabilityService.CreateCapability:input_type -> aethercore.v1.CreateCapabilityRequest
	3,  // 17: aethercore.v1.CapabilityService.GetCapability:input_type -> aethercore.v1.GetCapabilityRequest
	2,  // 18: aethercore.v1.CapabilityService.UpdateCapability:input_type -> aethercore.v1.UpdateCapabilityRequest
	4,  // 19: aethercore.v1.CapabilityService.DeleteCapability:input_type -> aethercore.v1.DeleteCapabilityRequest
	5,  // 20: aethercore.v1.CapabilityService.ListCapabilities:input_type -> aethercore.v1.ListCapabilitiesRequest
	6,  // 21: aethercore.v1.CapabilityService.CreateCapability:output_type -> aethercore.v1.CapabilityResponse
	6,  // 22: aethercore.v1.CapabilityService.GetCapability:output_type -> aethercore.v1.CapabilityResponse
	6,  // 23: aethercore.v1.CapabilityService.UpdateCapability:output_type -> aethercore.v1.CapabilityResponse
	12, // 24: aethercore.v1.CapabilityService.DeleteCapability:output_type -> aethercore.v1.DeleteResponse
	7,  // 25: aethercore.v1.CapabilityService.ListCapabilities:output_type -> aethercore.v1.ListCapabilitiesResponse
...
func init() { file_aethercore_v1_capability_service_proto_init() }
func file_aethercore_v1_capability_service_proto_init() {
	if File_aethercore_v1_capability_service_proto != nil {
		return
	}
	file_aethercore_v1_common_proto_init()
	file_aethercore_v1_capability_service_proto_msgTypes[0].OneofWrappers = []any{}
	file_aethercore_v1_capability_service_proto_msgTypes[1].OneofWrappers = []any{}
	file_aethercore_v1_capability_service_proto_msgTypes[2].OneofWrappers = []any{}
	file_aethercore_v1_capability_service_proto_msgTypes[8].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_aethercore_v1_capability_service_proto_rawDesc), len(file_aethercore_v1_capability_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_aethercore_v1_capability_service_proto_goTypes,
		DependencyIndexes: file_aethercore_v1_capability_service_proto_depIdxs,
		MessageInfos:      file_aethercore_v1_capability_service_proto_msgTypes,
	}.Build()
	File_aethercore_v1_capability_service_proto = out.File
	file_aethercore_v1_capability_service_proto_goTypes = nil
	file_aethercore_v1_capability_service_proto_depIdxs = nil
}
