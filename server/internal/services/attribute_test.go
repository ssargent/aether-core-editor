...
func TestAttributeService_CreateAttribute(t *testing.T) {
	...
	req := connect.NewRequest(&aethercorev1.CreateAttributeRequest{
		Name:        "Strength",
...
func TestAttributeService_GetAttribute(t *testing.T) {
	req := connect.NewRequest(&aethercorev1.GetAttributeRequest{
		Id: 1,
	})
...
func TestAttributeService_UpdateAttribute(t *testing.T) {
	req := connect.NewRequest(&aethercorev1.UpdateAttributeRequest{
		Id:          1,
		Name:        "Strength",
...
func TestAttributeService_DeleteAttribute(t *testing.T) {
	req := connect.NewRequest(&aethercorev1.DeleteAttributeRequest{
		Id: 1,
	})
...
func TestAttributeService_ListAttributes(t *testing.T) {
	req := connect.NewRequest(&aethercorev1.ListAttributesRequest{
		Name: "Strength",
	})
